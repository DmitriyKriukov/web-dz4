...
$workExperience = [
    [
        ...
        'dateStart' => 'Янвать 2015',
        'dateEnd' => 'Текущее время',
        'description' => 'Описание работы Front End разработчика',
    ],
    [
        'name' => 'Web разработчик',
        'dateStart' => 'Май 2012',
        'dateEnd' => 'Декабрь 2014',
        'description' => 'Описание работы Web разработчика',
    ],
    [
            ...
            <div class="w3-twothird">
                <div class="w3-container w3-card w3-white w3-margin-bottom">
                    ...
                    <div class="w3-container">
                        ...
                        <p><?php echo $workExperience[$i]["description"]; ?></p><hr>
                    </div>
                    <?php endfor; ?>
                </div>
